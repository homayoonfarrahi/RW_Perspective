function MeasurementsUI(vertices, perspectiveTool, paper) {
  ...
  this.update = function(vertices) {
    ...
    upsideLabel.attr('stroke', '#ff3');
    upsideLabel.attr('font-size', 13);
    upsideLabel.attr('font-weight', 'lighter');
